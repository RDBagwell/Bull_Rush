addEventListener('load', function () {
    ...
    class Player {
        ...
        update(){
            ...
            if(this.sprite.frame.x < this.sprite.frame.maxFrame){
                this.sprite.frame.x++;
            } else {
    ...
    class Larva {
        constructor(game, x, y){
            this.game = game;
            this.spriteImage = new Image();
            this.spriteImage.src = '../img/larva_sprite.png';
            this.collision = { 
                x: x,
                y: y,
                radius: 30
    ...
    class ToadSkin extends Enemy {
        constructor(game){
            super(game);
            this.spriteImage = new Image();
            this.spriteImage.src = '../img/toadskin.png';
            this.sprite = {
                image: this.spriteImage,
                width:  154,
                height: 238,
    ...
    class BarkSkin extends Enemy {
        constructor(game){
            super(game);
            this.spriteImage = new Image();
            this.spriteImage.src = '../img/barkskin.png';
            this.sprite = {
                image: this.spriteImage,
                width:  183,
                height: 280,
